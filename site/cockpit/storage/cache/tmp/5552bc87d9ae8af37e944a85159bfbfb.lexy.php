<?php $app->start('header'); ?>
    ...
    <?php echo  $app->assets(['mediamanager:assets/pathpicker.js'], $app['cockpit/version']) ; ?>

    <?php echo  $app->assets(['galleries:assets/galleries.js','galleries:assets/js/gallery.js'], $app['cockpit/version']) ; ?>
...
<div data-ng-controller="gallery" data-id="<?php echo  $id ; ?>" ng-cloak>

    <nav class="uk-navbar uk-margin-large-bottom">
        <span class="uk-navbar-brand">
            <a href="<?php $app->route("/galleries"); ?>"><?php echo $app("i18n")->get('Galleries'); ?></a> /
            <span class="uk-text-muted" ng-show="!gallery.name"><?php echo $app("i18n")->get('Gallery'); ?></span>
            <span ng-show="gallery.name">{{ gallery.name }}</span>
        </span>
        <ul class="uk-navbar-nav">
            <li data-uk-dropdown>
                <a title="<?php echo $app("i18n")->get('Add images to gallery'); ?>" data-uk-tooltip="{pos:'right'}"><i class="uk-icon-plus-circle"></i></a>
                <div class="uk-dropdown uk-dropdown-navbar">
                    <ul class="uk-nav uk-nav-navbar">
                        <li class="uk-nav-header"><?php echo $app("i18n")->get("Import"); ?></li>
                        <li><a href="#" ng-click="selectImage()"><i class="uk-icon-reply"></i> <?php echo $app("i18n")->get('Single image'); ?></a></li>
                        <li><a href="#" ng-click="importFromFolder()"><i class="uk-icon-reply-all"></i> <?php echo $app("i18n")->get('Images from folder'); ?></a></li>
                    </ul>
                </div>
            </li>
    ...
    <form class="uk-form" data-ng-submit="save()" data-ng-show="gallery">
            ...
            <div class="uk-grid">
                ...
                <div class="uk-width-medium-4-5">
                    ...
                    <div class="app-panel">
                        ...
                        <div class="uk-form-row">
                            <input class="uk-width-1-1 uk-form-large" type="text" placeholder="<?php echo $app("i18n")->get('Name'); ?>" data-ng-model="gallery.name" required>
                            <div class="uk-margin-top">
                                <input class="uk-width-1-1 uk-form-blank uk-text-muted" type="text" data-ng-model="gallery.slug" app-slug="gallery.name" placeholder="<?php echo $app("i18n")->get('Slug...'); ?>" title="slug" data-uk-tooltip="{pos:'left'}">
                            </div>
                        </div>
                            ...
                            <div data-ng-show="!managefields">
                                ...
                                <ul id="images-list" class="uk-grid uk-sortable" data-uk-grid-match="{target:'.uk-thumbnail'}" data-uk-sortable>
                                    <li class="uk-width-1-2 uk-width-medium-1-5 uk-grid-margin" data-ng-repeat="image in gallery.images" draggable="true">
                                        <div class="uk-thumbnail uk-width-1-1 uk-text-center uk-visible-hover">
                                            <div class="uk-text-center" style="background: #fff url(<?php $app->route('/mediamanager/thumbnail'); ?>/{{ image.path|base64 }}/200/200) 50% 50% no-repeat;background-size:contain;height:140px;">
                                ...
                                <div class="uk-text-center uk-margin-large-top uk-margin-large-bottom" data-ng-show="gallery && !gallery.images.length">
                                    ...
                                    <p class="uk-text-muted uk-text-large">
                                        <?php echo $app("i18n")->get('You don\'t have any images in this gallery.'); ?>
                                    </p>
                                </div>
                                        ...
                                        <div class="uk-nestable-item uk-nestable-item-table">
                                            ...
                                            <div class="uk-grid uk-grid-small">
                                                <div class="uk-width-3-4">
                                                    ...
                                                    <input class="uk-width-2-3 uk-form-blank" type="text" data-ng-model="field.name" placeholder="<?php echo $app("i18n")->get('Field name'); ?>" pattern="[a-zA-Z0-9]+" required>
                                                </div>
                        ...
                        <div class="uk-form-row">
                            <button type="submit" class="uk-button uk-button-primary uk-button-large"><?php echo $app("i18n")->get('Save gallery'); ?></button> &nbsp;
                            <a href="<?php $app->route('/galleries'); ?>"><?php echo $app("i18n")->get('Cancel'); ?></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="uk-width-medium-1-5">
                    ...
                    <div class="uk-form-row">
                        ...
                        <div class="uk-form-controls uk-margin-small-top">
                            <div class="uk-form-select">
                                ...
                                <a>{{ gallery.group || '- <?php echo $app("i18n")->get("No group"); ?> -' }}</a>
                    ...
                    <div class="uk-form-row">
                        <strong><?php echo $app("i18n")->get("Meta fields"); ?></strong>
                        ...
                        <div class="uk-margin-small-top">
                            ...
                            <p class="uk-text-muted" ng-show="!gallery.fields.length">
                                <?php echo $app("i18n")->get('No meta fields defined.'); ?>
                            </p>
                        </div>

                        <button type="button" class="uk-button" data-ng-class="managefields ? 'uk-button-success':'uk-button-primary'" data-ng-click="switchFieldsForm(managefields)" title="<?php echo $app("i18n")->get('Manage meta fields'); ?>">
    ...
    <div id="meta-dialog" class="uk-modal">
        <div class="uk-modal-dialog">
            ...
            <h3><?php echo $app("i18n")->get('Meta'); ?></h3>
            ...
            <button class="uk-button uk-modal-close"><?php echo $app("i18n")->get('Close'); ?></button>
        </div>
    </div>
