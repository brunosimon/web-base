<?php $app->start('header'); ?>
    ...
    <?php echo  $app->assets(['collections:assets/collections.js','collections:assets/js/index.js'], $app['cockpit/version']) ; ?>
...
<div data-ng-controller="collections" ng-cloak>
    ...
    <nav class="uk-navbar uk-margin-large-bottom">
        <span class="uk-hidden-small uk-navbar-brand"><?php echo $app("i18n")->get('Collections'); ?></span>
        ...
        <ul class="uk-navbar-nav">
            <li><a href="<?php $app->route('/collections/collection'); ?>" title="<?php echo $app("i18n")->get('Add collection'); ?>" data-uk-tooltip="{pos:'right'}"><i class="uk-icon-plus-circle"></i></a></li>
        </ul>
        <?php } ?>
    ...
    <div class="uk-grid uk-grid-divider" data-uk-grid-match data-ng-show="collections && collections.length" data-uk-grid-margin>
        ...
        <div class="uk-width-medium-1-4">
            <div class="uk-panel">
                <ul class="uk-nav uk-nav-side uk-nav-plain" ng-show="groups.length">
                    ...
                    <li ng-class="activegroup=='-all' ? 'uk-active':''" ng-click="(activegroup='-all')"><a><?php echo $app("i18n")->get("All collections"); ?></a></li>
                </ul>
                ...
                <div class="uk-text-muted" ng-show="!groups.length">
                    <?php echo $app("i18n")->get('Create groups to organize your collections.'); ?>
                </div>
        ...
        <div class="uk-width-medium-3-4">
            ...
            <div class="uk-margin-bottom">
                <span class="uk-badge app-badge">{{ (activegroup=='-all' ? '<?php echo $app("i18n")->get("All collections"); ?>' : activegroup) }}</span>
            </div>
            ...
            <div class="uk-grid uk-grid-small" data-uk-grid-match data-ng-if="collections && collections.length && mode=='list'">
                <div class="uk-width-1-1 uk-width-medium-1-3 uk-grid-margin" data-ng-repeat="collection in collections track by collection._id" data-ng-show="matchName(collection.name) && inGroup(collection.group)">
                    ...
                    <div class="app-panel">
                        ...
                        <a class="uk-link-muted" href="<?php $app->route('/collections/entries'); ?>/{{ collection._id }}"><strong>{{ collection.name }}</strong></a>

                        <div class="uk-margin">
                            <span class="uk-badge app-badge">{{ collection.count }} <?php echo $app("i18n")->get('Entries'); ?></span>
                        </div>
                            ...
                            <div class="uk-link" data-uk-dropdown="{mode:'click'}">
                                ...
                                <div class="uk-dropdown">
                                    <ul class="uk-nav uk-nav-dropdown uk-nav-parent-icon">
                                        ...
                                        <li><a href="<?php $app->route('/collections/entries'); ?>/{{ collection._id }}"><i class="uk-icon-list"></i> <?php echo $app("i18n")->get('Show entries'); ?></a></li>
                                        <li><a href="<?php $app->route('/collections/entry'); ?>/{{ collection._id }}"><i class="uk-icon-plus-circle"></i> <?php echo $app("i18n")->get('Create new entry'); ?></a></li>
                                        <?php if ($app->module("auth")->hasaccess("Collections", 'manage.collections')) { ?>
                                        <li class="uk-nav-divider"></li>
                                        <li><a href="<?php $app->route('/collections/collection'); ?>/{{ collection._id }}"><i class="uk-icon-pencil"></i> <?php echo $app("i18n")->get('Edit collection'); ?></a></li>
                                        <li><a ng-click="duplicate(collection._id)"><i class="uk-icon-copy"></i> <?php echo $app("i18n")->get('Duplicate collection'); ?></a></li>
                                        <li class="uk-nav-divider"></li>
                                        <li class="uk-danger"><a data-ng-click="remove($index, collection)" href="#"><i class="uk-icon-minus-circle"></i> <?php echo $app("i18n")->get('Delete collection'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                            </div>
                ...
                <table class="uk-table uk-table-striped" multiple-select="{model:collections}">
                    <thead>
                        <tr>
                            ...
                            <th width="60%"><?php echo $app("i18n")->get('Collection'); ?></th>
    ...
    <div class="uk-text-center app-panel" data-ng-show="collections && !collections.length">
        ...
        <?php if ($app->module("auth")->hasaccess("Collections", 'manage.collections')) { ?>
        <a href="<?php $app->route('/collections/collection'); ?>" class="uk-button uk-button-success uk-button-large"><?php echo $app("i18n")->get('Create a collection'); ?></a>
        <?php } ?>
    </div>
