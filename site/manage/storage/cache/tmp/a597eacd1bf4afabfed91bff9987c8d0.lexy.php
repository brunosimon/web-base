<div data-ng-controller="backups" ng-cloak>
    ...
    <nav class="uk-navbar uk-margin-large-bottom">
        <span class="uk-navbar-brand"><a href="<?php $app->route('/settingspage'); ?>"><?php echo $app("i18n")->get('Settings'); ?></a> / <?php echo $app("i18n")->get('Backups'); ?></span>
    </nav>
        ...
        <div class="uk-width-medium-2-3">
            ...
            <div class="app-panel">
                ...
                <table class="uk-table uk-table-striped" data-ng-show="backups.length">
                    <thead>
                        <th width="20">&nbsp;</th>
                        <th><?php echo $app("i18n")->get('Date'); ?></th>
                        <th><?php echo $app("i18n")->get('Size'); ?></th>
                        <th width="20">&nbsp;</th>
                    </thead>
                    <tbody>
                                ...
                                <div data-uk-dropdown>
                                    ...
                                    <div class="uk-dropdown uk-dropdown-flip uk-text-left">
                                        <ul class="uk-nav uk-nav-dropdown">
                                            <li><a href="<?php echo  $app->pathToUrl('#backups:') ; ?>{{ backup.file }}.zip"><i class="uk-icon-cloud-download"></i> <?php echo $app("i18n")->get('Download backup'); ?></a></li>
                                            <li><a href="#" data-ng-click="remove($index, backup)"><i class="uk-icon-trash-o"></i> <?php echo $app("i18n")->get('Delete backup'); ?></li>
                                        </ul>
                                    </div>
                                </div>
                            </td>
                ...
                <div class="uk-text-center" data-ng-show="backups && !backups.length">
                    ...
                    <p class="uk-text-large">
                        <?php echo $app("i18n")->get('You don\'t have any backups created.'); ?>
                    </p>
                </div>
        ...
        <div class="uk-width-medium-1-3">
            ...
            <div data-uk-dropdown>
                <button class="uk-button uk-button-large uk-button-primary">
                    <?php echo $app("i18n")->get('Create a new backup'); ?>
                </button>
            ...
            <div class="uk-text-truncate uk-text-small">
                <?php echo $app("i18n")->get('Backups are located here'); ?>:
                <p class="uk-margin">
                    <strong><i class="uk-icon-folder-open"></i> <?php echo  $app->pathToUrl("#backups:") ; ?></strong>
                </p>
            </div>
        </div>
...
<script>
    ...
    App.module.controller("backups", function($scope, $rootScope, $http, $timeout){
        ...
        $scope.backups = <?php echo  json_encode($backups) ; ?>;
